...
@section('content')
    <div class="container-fluid profile-content">
        ...
        <div class="row" v-else>
            ...
            <a href="https://access.line.me/dialog/oauth/weblogin?response_type=code&client_id=1577161245&redirect_uri=http://localhost:7000/line&state={{ csrf_token() }}">Line Login</a>
        </div>
