                    ...
                    <tbody class="tbody-text">
                        @foreach ($settings as $setting)
                            <tr>
                                ...
                                @endif
                                <td>
                                    <a href="/r2sup/accept/{{ $setting->account_id }}" class="btn btn-light"><i class="fa fa-check"></i></a>
                                    <a href="/r2sup/decline/{{ $setting->account_id }}" class="btn btn-light"><i class="fa fa-times"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
